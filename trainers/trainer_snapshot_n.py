...
def train_parser():
    ...
    parser.add_argument("--lr", help="initial learning rate", type=float, default=1e-1)
    parser.add_argument("--gamma", help="learning rate cut scalar", type=float, default=0.1)
    parser.add_argument("--epoch", help="number of epochs before lr is cut by gamma", type=int, default=240)
    parser.add_argument("--stage", help="number lr stages", type=int, default=5)
    ...
    parser.add_argument("--resnet", help="whether use resnet12 as backbone or not", default=False)
    parser.add_argument("--nesterov", help="nesterov for sgd", default=True)
    ...
    parser.add_argument("--pre", help="whether use pre-resized 84x84 images for val and test", default=False)
    parser.add_argument("--no_val", help="don't use validation set, just save model at final timestep", default=True)
    parser.add_argument("--train_way", help="training way", type=int, default=30)
...
class Train_Manager:
    ...
    def __init__(self,args,path_manager,train_func):
        ...
        self.logger = get_logger('2%s.log' % (name))
        self.save_path = '2model_%s.pth' % (name)
