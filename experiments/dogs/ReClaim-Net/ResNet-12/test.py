...
model_path = '/media/ai-pc2503021/9EBA6B93BA6B66AD/code/zwy/Bi-FRN-main/experiments/dogs/ReClaim-Net/ResNet-12/six1model_ResNet-12.pth'

gpu = 0
torch.cuda.set_device(gpu)

model = ReClaimNet(resnet=True)
model.cuda()
